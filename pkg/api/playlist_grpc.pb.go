...
func (c *playlistClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/api.Playlist/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPlaylistServer) Get(context.Context, *GetRequest) (*GetResponse, error) {
...
func _Playlist_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Playlist/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistServer).Get(ctx, req.(*GetRequest))
	}
...
var Playlist_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/playlist.proto",
}
